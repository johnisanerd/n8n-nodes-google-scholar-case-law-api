...
import { ACTOR_ID } from '../ApifyScholarCaseLaw.node';
import { buildActorInput } from '../ApifyScholarCaseLaw.properties';
...
/**
 * Shape a single case-law row according to the chosen Output mode.
