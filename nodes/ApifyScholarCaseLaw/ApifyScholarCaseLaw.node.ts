...
import { properties } from './ApifyScholarCaseLaw.properties';
import { runActor } from './helpers/executeActor';

// SNIPPET 1: Make sure the constants are correct
export const ACTOR_ID = 'w8SNoAPyZLk7sLuOl' as string;

export const PACKAGE_NAME = 'n8n-nodes-google-scholar-case-law-api' as string;
export const CLASS_NAME = 'ApifyScholarCaseLaw' as string;
...
export const X_PLATFORM_APP_HEADER_ID = 'google-scholar-case-law-app' as string;

export const DISPLAY_NAME = 'Google Scholar Case Law' as string;
export const DESCRIPTION =
	'Search US state and federal case law on Google Scholar and pull full case details' as string;

export class ApifyScholarCaseLaw implements INodeType {
